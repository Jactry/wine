...
static void test_ITextRange_SetStart(void)
{
  ...
  hres = ITextRange_SetStart(txtRge, 2);
  ...
  hres = ITextRange_SetStart(txtRge, 13);
  ok(hres == S_OK, "ITextRange_SetStart\n");
  ITextRange_GetStart(txtRge, &start);
  ITextRange_GetEnd(txtRge, &end);
  ok(start == 12, "got wrong start value: %d\n", start);
  ...
  ITextRange_SetRange(txtRge, 0, 13);
  hres = ITextRange_SetStart(txtRge, 13);
  ok(hres == S_OK, "ITextRange_SetStart\n");
  ITextRange_GetStart(txtRge, &start);
  ITextRange_GetEnd(txtRge, &end);
  ...
  ITextRange_SetRange(txtRge, 0, 8);
  hres = ITextRange_SetStart(txtRge, 8);
  ok(hres == S_OK, "ITextRange_SetStart\n");
  ITextRange_GetStart(txtRge, &start);
  ITextRange_GetEnd(txtRge, &end);
  ok(start == 8, "got wrong start value: %d\n", start);
...
static void test_ITextSelection_SetRange(void)
{
  HWND w;
  IRichEditOle *reOle = NULL;
  ITextDocument *txtDoc = NULL;
  ...
  create_interfaces(&w, &reOle, &txtDoc, &txtSel);
  SendMessageA(w, WM_SETTEXT, 0, (LPARAM)test_text1);
  SendMessageA(w, EM_SETSEL, 0, 0);

  hres = ITextSelection_SetRange(txtSel, 2, 4);
  ok(hres == S_OK, "ITextRange_SetRange\n");
  ITextSelection_GetStart(txtSel, &start);
  ITextSelection_GetEnd(txtSel, &end);
  ok(start == 2, "got wrong start value: %d\n", start);
  ok(end == 4, "got wrong end value: %d\n", end);
  ...
  hres = ITextSelection_SetRange(txtSel, 4, 2);
  ok(hres == S_FALSE, "ITextRange_SetRange\n");
  ITextSelection_GetStart(txtSel, &start);
  ITextSelection_GetEnd(txtSel, &end);
  ok(start == 2, "got wrong start value: %d\n", start);
  ...
  hres = ITextSelection_SetRange(txtSel, 14, 14);
  ok(hres == S_OK, "ITextRange_SetRange\n");
  ITextSelection_GetStart(txtSel, &start);
  ITextSelection_GetEnd(txtSel, &end);
  ok(start == 12, "got wrong start value: %d\n", start);
  ...
  hres = ITextSelection_SetRange(txtSel, 15, 15);
  ok(hres == S_FALSE, "ITextRange_SetRange\n");
  ITextSelection_GetStart(txtSel, &start);
  ITextSelection_GetEnd(txtSel, &end);
  ok(start == 12, "got wrong start value: %d\n", start);
  ...
  hres = ITextSelection_SetRange(txtSel, 14, 1);
  ok(hres == S_OK, "ITextRange_SetRange\n");
  ITextSelection_GetStart(txtSel, &start);
  ITextSelection_GetEnd(txtSel, &end);
  ok(start == 1, "got wrong start value: %d\n", start);
  ...
  hres = ITextSelection_SetRange(txtSel, -1, 4);
  ok(hres == S_OK, "ITextRange_SetRange\n");
  ITextSelection_GetStart(txtSel, &start);
  ITextSelection_GetEnd(txtSel, &end);
  ok(start == 0, "got wrong start value: %d\n", start);
...
static void test_ITextSelection_SetStart(void)
{
  ...
  hres = ITextSelection_SetStart(txtSel, 2);
  ...
  hres = ITextSelection_SetStart(txtSel, 13);
  ok(hres == S_OK, "ITextSelection_SetStart\n");
  SendMessageA(w, EM_GETSEL, (LPARAM)&start, (WPARAM)&end);
  ok(start == 12, "got wrong start value: %d\n", start);
  ok(end == 12, "got wrong end value: %d\n", end);
  ...
  SendMessageA(w, EM_SETSEL, 0, 8);
  hres = ITextSelection_SetStart(txtSel, 8);
  ok(hres == S_OK, "ITextSelection_SetStart\n");
  SendMessageA(w, EM_GETSEL, (LPARAM)&start, (WPARAM)&end);
  ok(start == 8, "got wrong start value: %d\n", start);
  ok(end == 8, "got wrong end value: %d\n", end);
...
static void test_ITextSelection_SetEnd(void)
{
  ...
  hres = ITextSelection_SetEnd(txtSel, 6);
  ok(hres == S_OK, "ITextSelection_SetEnd\n");
  SendMessageA(w, EM_GETSEL, (LPARAM)&start, (WPARAM)&end);
  ok(start == 4, "got wrong start value: %d\n", start);
  ok(end == 6, "got wrong end value: %d\n", end);

  hres = ITextSelection_SetEnd(txtSel, 14);
  ok(hres == S_OK, "ITextSelection_SetEnd\n");
  SendMessageA(w, EM_GETSEL, (LPARAM)&start, (WPARAM)&end);
  ok(start == 4, "got wrong start value: %d\n", start);
  ok(end == 13, "got wrong end value: %d\n", end);
